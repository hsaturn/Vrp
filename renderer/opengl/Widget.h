...
namespace hwidgets {
	...
	public:
		...
		bool isAbsolute() const { return !percent; };
	...
	public:
		...
		int width() const { return c2->getAbsoluteX(); }
		int height() const { return c2->getAbsoluteY(); }
		int x1() const {return c1->getAbsoluteX(); }
		int x2() const {return c1->getAbsoluteX()+c2->getAbsoluteX(); }
		int y1() const {return c1->getAbsoluteY(); }
		int y2() const {return c1->getAbsoluteY()+c2->getAbsoluteY(); }
	...
	public:
		...
		int width() { return mrect->width(); }
		int height() { return mrect->height(); }
		...
		static void setCmdQueue(list<string>* p) { cmdQueue=p; }
	...
	protected:
		...
		virtual bool script(const string& s){ return false; };
